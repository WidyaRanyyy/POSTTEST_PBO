 ...
 *  └──────────────────────┴──────────────┴─────────────────────────────┘
 *
 *  Tipe Inheritance: Single Inheritance
 *  - KamarStandard, KamarDeluxe, KamarSuite masing-masing extends Kamar
 *  - TamuVIP extends Tamu
 *
 ...
 *  │ protected    │ poinLoyalitas di Tamu, kapasitasOrang di Kamar   │
...
public class HotelManagement {
    ...
    private static void tampilMenuUtama() {
        ...
        System.out.println("║           [ Posttest 3 - Inheritance ]       ║");
        System.out.println("╠══════════════════════════════════════════════╣");
